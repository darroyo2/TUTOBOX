 ...
 * @author HP
 */
@WebServlet(name = "InscripcionTutoriaServlet", urlPatterns = {"/InscripcionTutoriaServlet"})
public class InscripcionTutoriaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher vista = request.getRequestDispatcher("PrincipalUsuario.jsp");
